...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-831-erd-s-problem-831-00afdae2-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-831"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-831-erd-s-problem-831-00afdae2-v1",
      "problem_contract_sha256": "82fb149e0d9e921b987f33626572778904d61fe11400a23300e4ad477288a8f9",
      "problem_id": "problem:um-ep-831-erd-s-problem-831-00afdae2",
      "route_id": "route:um-ep-831-erd-s-problem-831-00afdae2-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-831-erd-s-problem-831-00afdae2-source-fidelity-01",
      "graph_id": "graph:um-ep-831-erd-s-problem-831-00afdae2-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-831-erd-s-problem-831-00afdae2-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-831-erd-s-problem-831-00afdae2-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $h(n)$ be maximal such that in any $n$ points in $\\mathbb{R}^2$ (with no three on a line and no four on a circle) there are at least $h(n)$ many circles of different radii passing through three points. Estimate $h(n)$. \", \"difficulty\": \"L1\" },{"
          },
          "statement_sha256": "7de024abde7ad9673b87332defcf1dd8a7f31367a7b2f86dac1667198bf1c12e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-831-erd-s-problem-831-00afdae2-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-831-erd-s-problem-831-00afdae2-root",
      "route_id": "route:um-ep-831-erd-s-problem-831-00afdae2-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-831-a300252ae410",
        "url": "https://www.unsolvedmath.com/problems/EP-831"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
